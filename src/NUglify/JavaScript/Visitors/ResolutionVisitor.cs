...
namespace NUglify.JavaScript.Visitors
{
    ...
    public class ResolutionVisitor : IVisitor
    {
        ...
        public static void Apply(BlockStatement block, ActivationObject scope, JSParser parser)
        {
            ...
            else
            {
                ...
                else if (ghostField.IsReferenced)
                {
                    ...
                    if (IsBindingIdentifierWithName(parentVarDecl, binding.Name))
                    {
                        ...
                        var parentAssignment = funcObject.Parent as BinaryExpression;
                        if (parentAssignment == null || parentAssignment.OperatorToken != JSToken.Assign
                            || parentAssignment.Operand2 != funcObject
                            || (lookup = parentAssignment.Operand1 as LookupExpression) == null
